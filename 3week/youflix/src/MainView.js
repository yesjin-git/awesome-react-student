...
import './MainView.css';
import ConetntList from "./ContentList.js";
...
class MainView extends Component {
	constructor(props) {
      ...
      this.state = {
      	fullContent: {},
	  	contents : this.selectContents(this.src,5)
	  };

	  this.extractContents(this.src)
	}
  ...
  componentDidMount() {
  	this.intervarId = setInterval(()=> {
  		...
  		this.setState({contents:this.selectContents(this.src,5)})
  	}, 100000)
  }
